...
const product_home = async(req,res)=>{
    const testAPI = await axios.get(`https://osf-digital-backend-academy.herokuapp.com/api/products/product_search?primary_category_id=${req.params.child}&secretKey=$2a$08$3t1EKtnyypsPeVZIrS7B9uWGSb/lRdd2z5H6nN/BPh4GuDPXeC5Du`)
